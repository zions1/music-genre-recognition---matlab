function frameMat2 = frameZeroMean(frameMat, polyOrder, showPlot);
...
for i=1:frameNum
	trend=polyval(polyfit(x2, frameMat(:,i), polyOrder), x2);
	frameMat2(:,i)=frameMat(:,i)-trend;
end

if n==1 & showPlot
	plot(1:m, frameMat, 1:m, trend, 1:m, frameMat2);
	xlabel('Frame index'); ylabel('Amplitude');
	legend('Original frame', 'Trend by polyfit', 'Modified frame');
end
