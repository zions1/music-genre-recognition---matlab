function [f, p, r, accuracy, tpCount, fpCount, fnCount]=simSequence(computed, gt, tolerance, showPlot)
...
if showPlot
	...
	line([minValue-margin, maxValue+margin], 0*[1 1], 'color', 'k');
	box on
	axis([minValue-margin, maxValue+margin, -height*2, height*2]);
