...
%
% <html>
% <p>mmSet=mmSetCollect(mmDir, extName, showPlot) returns a structure array of multimedia data that is collected from the given directory with given file extension names.
% 	<ul>
...
% 	<li>mmSet: A structure array of all the collected multimedia files
% 	</ul>
% </html>
%% Example
%%
